         ...
         className='nav-container font-poppins'>
            ...
            <nav className="right">
                <ul>
                    ...
                    <li><Link className={`${currentPage === "doctors" && !inLogin? "green" : "hover:text-emerald-600 transition-all"}`} to='/doctor' onClick={() =>setCurrentPage("doctors")}>Doctors</Link></li>
                    ...
                    {inLogin?<li className='hidden'></li>:<li><Link className={`${currentPage === "virtual" ? "green" : "hover:text-emerald-600 transition-all"}`} to='/chat' onClick={() =>setCurrentPage("virtual")}>Virtual Diagnosis</Link></li>}
                </ul>
            </nav>
